<?php /* Smarty version 2.6.25, created on 2017-04-16 03:39:04
...
<?php $this->_cache_serials['/home/valeksa/public_html/tmp/templates_c/65e7d4b72627b18bf5ae0525d49da18d^%%E7^E7F^E7F946DE%%module_db_tpl%3AMenuManager%3Bleftmenu.inc'] = '8ff66e721b3b575830242ae917457a3b'; ?><?php if (count($this->_tpl_vars['nodelist']) > 0): ?>
...
<?php if ($this->caching && !$this->_cache_including): echo '{nocache:8ff66e721b3b575830242ae917457a3b#0}'; endif;$_cache_attrs =& $this->_smarty_cache_attrs('8ff66e721b3b575830242ae917457a3b','0');echo smarty_cms_function_repeat(array('string' => "<ul>",'times' => $this->_tpl_vars['node']->depth-$this->_tpl_vars['node']->prevdepth), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:8ff66e721b3b575830242ae917457a3b#0}'; endif;?>

<?php elseif ($this->_tpl_vars['node']->depth < $this->_tpl_vars['node']->prevdepth): ?>
<?php if ($this->caching && !$this->_cache_including): echo '{nocache:8ff66e721b3b575830242ae917457a3b#1}'; endif;$_cache_attrs =& $this->_smarty_cache_attrs('8ff66e721b3b575830242ae917457a3b','1');echo smarty_cms_function_repeat(array('string' => "</li></ul>",'times' => $this->_tpl_vars['node']->prevdepth-$this->_tpl_vars['node']->depth), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:8ff66e721b3b575830242ae917457a3b#1}'; endif;?>
...
<?php endif; ?>
<?php endforeach; endif; unset($_from); ?>
<?php if ($this->caching && !$this->_cache_including): echo '{nocache:8ff66e721b3b575830242ae917457a3b#2}'; endif;$_cache_attrs =& $this->_smarty_cache_attrs('8ff66e721b3b575830242ae917457a3b','2');echo smarty_cms_function_repeat(array('string' => "</li></ul>",'times' => $this->_tpl_vars['node']->depth-1), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:8ff66e721b3b575830242ae917457a3b#2}'; endif;?>
</li>
<?php else: ?>
