<?php /* Smarty version 2.6.25, created on 2017-04-16 03:39:22
...
<?php $this->_cache_serials['/home/valeksa/public_html/tmp/templates_c/ccb744902b2bac8ab89a3ca26bf5f92f^%%E7^E7F^E7F946DE%%module_db_tpl%3AMenuManager%3Bleftmenu.inc'] = 'b8bf7e04bf384142731cf2fda7ca77ac'; ?><?php if (count($this->_tpl_vars['nodelist']) > 0): ?>
...
<?php if ($this->caching && !$this->_cache_including): echo '{nocache:b8bf7e04bf384142731cf2fda7ca77ac#0}'; endif;$_cache_attrs =& $this->_smarty_cache_attrs('b8bf7e04bf384142731cf2fda7ca77ac','0');echo smarty_cms_function_repeat(array('string' => "<ul>",'times' => $this->_tpl_vars['node']->depth-$this->_tpl_vars['node']->prevdepth), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:b8bf7e04bf384142731cf2fda7ca77ac#0}'; endif;?>

<?php elseif ($this->_tpl_vars['node']->depth < $this->_tpl_vars['node']->prevdepth): ?>
<?php if ($this->caching && !$this->_cache_including): echo '{nocache:b8bf7e04bf384142731cf2fda7ca77ac#1}'; endif;$_cache_attrs =& $this->_smarty_cache_attrs('b8bf7e04bf384142731cf2fda7ca77ac','1');echo smarty_cms_function_repeat(array('string' => "</li></ul>",'times' => $this->_tpl_vars['node']->prevdepth-$this->_tpl_vars['node']->depth), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:b8bf7e04bf384142731cf2fda7ca77ac#1}'; endif;?>
...
<?php endif; ?>
<?php endforeach; endif; unset($_from); ?>
<?php if ($this->caching && !$this->_cache_including): echo '{nocache:b8bf7e04bf384142731cf2fda7ca77ac#2}'; endif;$_cache_attrs =& $this->_smarty_cache_attrs('b8bf7e04bf384142731cf2fda7ca77ac','2');echo smarty_cms_function_repeat(array('string' => "</li></ul>",'times' => $this->_tpl_vars['node']->depth-1), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:b8bf7e04bf384142731cf2fda7ca77ac#2}'; endif;?>
</li>
<?php else: ?>
