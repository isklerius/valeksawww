...
#
#$Id: Link.inc.php 6447 2010-07-02 06:40:08Z sjg $
...
class Link extends ContentBase
{
	...
	if (isset($params))
	{
	  $parameters = array('url');
	 	 ...
	 	 $this->AddExtraProperty('pricelist');
		  $this->AddExtraProperty('text_price');
		  $this->AddExtraProperty('nuoroda_price'); 
	...
	case '0':
	  ...
	  include_once ('../lib/customfields.php');
