...
if($params['id'])
	...
	$mainid = $_GET['prop_id'];
if (isset($params['submit']) && $this->CheckPermission($pavad.' Add') && $this->CheckFormid($params['formid'],$mainid) && $params['formid']!='' && $params['formid']!=0) 
{
...
if (!$this->CheckFormid($params['formid'],$mainid)) {
  echo $this->Lang('idyra');
}
if(isset($params['submit']) && ($params['formid']=='' || $params['formid']==0)){
	echo $this->Lang('idnull');
}
