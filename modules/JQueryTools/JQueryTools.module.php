...
class JQueryTools extends CGExtensions
{
  ...
  public function __construct()
  {
    ...
    $this->SetParameterType('include',CLEAN_STRING);
    $this->CreateParameter('include','',$this->Lang('param_include'));
    ...
    $this->CreateParameter('no_css','',$this->Lang('param_no_css'));
    $this->CreateParameter('no_js','',$this->Lang('param_no_js'));
    $this->CreateParameter('exclude','',$this->Lang('param_exclude'));
    $this->CreateParameter('action','',$this->Lang('param_action'));
    $this->CreateParameter('no_jquery','',$this->Lang('param_no_jquery'));
  }
