...
$lang['admindescription'] = 'Ten moduł pozwala, żeby gł&oacute;wnie treści, ale r&oacute;wnież inne rodzaje danych (blok&oacute;w danych) - były edytowalne przez aplikację WYSIWYG, edytor do łatwego wpisywania - projektu TinyMCE.';
...
$lang['stiptags_help'] = 'Ta opcja pr&oacute;buje usunąć ustawienia tła (background) z arkusza stylu';
...
$lang['allowtables'] = 'Pozw&oacute;l na operacje na tabelkach';
...
$lang['usecompressionhelp'] = 'To może przyspieszyć ładowanie się TinyMCE, ale r&oacute;wnież może spowodować, że na niekt&oacute;rych systemach TinyMCE nie będzie się ładował w og&oacute;le. Używaj z uwagą i upewnij się, żę kompresja gz jest włączona.';
...
$lang['allowuploadtext'] = 'Pozw&oacute;l na wgrywanie plik&oacute;w i tworzenie katalog&oacute;w w FilePicker (okienku wyboru plik&oacute;w)';
...
$lang['allowadvancedprofile'] = 'Pozw&oacute;l na używanie zaawansowanego profilu w TinyMCE';
...
$lang['showthumbnailfilestext'] = 'Pokaż pliki miniaturek w liście plik&oacute;w';
$lang['filenameandthumbnails'] = 'Pokaż zar&oacute;wno pliki, jak i pliki miniaturek';
$lang['skinstext'] = 'Sk&oacute;rka';
$lang['skinvariationtext'] = 'Wariant sk&oacute;rki';
...
$lang['cmslinkerstyletext'] = 'Styl link&oacute;w a&#039;la CMS-linker';
$lang['cmsselflinkstyle'] = 'Styl link&oacute;w {cms_selflink}';
...
$lang['includeonlyscreencss_help'] = 'Zaznaczając to, tylko dołączone style z zaznaczoym typem media: screen będą dołączane do styli, kt&oacute;rymi rozporządza TinyMCE.';
$lang['usestaticconfigtext'] = 'Użyj statycznego pliku konfiguracyjnego (static config)';
$lang['usestaticconfighelp'] = 'Ta opcja może pom&oacute;c w uruchomieniu TinyMCE na systemach, gdzie oprogramowanie hostingu dodaje rzeczy takie jak statystyki do wszystich stron, zmieniając i psując dynamicznie tworzone javascriptowe pliki konfiguracyjne.';
...
$lang['ignoremodifyfilestext'] = 'Zignoruj uprawnienie &#039;Modyfikowanie Plik&oacute;w&#039; (&#039;Modify Files&#039;)  dla dodatku FilePicker (wybierania plik&oacute;w).';
