...
class NCleanGreyTheme extends AdminTheme
{
  function renderMenuSection($section, $depth, $maxdepth)
  {
	...
	function ThemeHeader(){
		...
		echo '	<link rel="stylesheet" type="text/css" href="themes/NCleanGrey/css/jquery-ui-1.8.16.custom.css" />'."\n";
		echo '<script type="text/javascript" src="themes/NCleanGrey/includes/jquery-1.6.2.min.js"></script>'."\n";
		echo '<script type="text/javascript" src="themes/NCleanGrey/includes/jquery-ui-1.8.16.custom.min.js"></script>'."\n";
